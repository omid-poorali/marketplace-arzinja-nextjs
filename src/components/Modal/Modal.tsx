...
export const Modal = React.forwardRef((props: PropsType, forwardedRef: React.Ref<HTMLDivElement>) => {
  const {
    open,
    center,
    blockScroll = true,
  ...
  mergeRefs([refDialog, forwardedRef]);
  ...
  if (refContainer.current === null && Utils.DOM.isBrowser) {
  ...
  const classes = {
    root: 'uiModal',
    overlay: 'uiModal-overlay',
    overlayAnimationIn: 'uiModal-overlay-in',
    overlayAnimationOut: 'uiModal-overlay-out',
    modalContainer: 'uiModal-container',
    modalContainerCenter: 'uiModal-containerCenter',
    modal: 'uiModal-modal',
    modalAnimationIn: 'uiModal-modal-in',
    modalAnimationOut: 'uiModal-modal-out',
  };
  ...
  return showPortal && containerModal
    ? ReactDOM.createPortal(
      ...
      >
        <div
          className={clsx(classes.overlay, classNames?.overlay)}
          data-testid="overlay"
          aria-hidden={true}
          style={{
        ...
        >
          <div
            ref={refDialog}
            className={clsx(classes.modal, classNames?.modal)}
            style={{
